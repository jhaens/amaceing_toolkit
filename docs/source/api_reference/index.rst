...
.. note::
   ...
   **Special handling of list parameters:**
   ...
   format without commas (e.g., ``[10.0 10.0 10.0]``).
   
   Example::
   
       # This works in the API
       config = {
           'pbc_list': [14.0, 14.0, 14.0],  # Will be automatically formatted correctly
       ...
       # where lists use spaces instead of commas: [14.0 14.0 14.0]
